...
//获取菜单列表
$dataList = AdminRule::getAllMenu($model->id);
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <a href="<?= Url::toRoute('index') ?>" class="btn">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <?= $form->field($model, 'order')
                                                ->textInput(['class' => 'col-md-offset-1  col-sm-3', 'placeholder' => '1'])
                                            ...
                                            <div class="form-group field-form-field-1 required">
                                                ...
                                                <label class="col-md-offset-1  col-sm-3">
                                                    <input name="AdminRule[is_show]"  <?php if ($model->is_show) echo  'checked';?> value="1"
                                            ...
                                            <div class="form-group field-form-field-1 required">
                                                ...
                                                <label class="col-md-offset-1  col-sm-3">
                                                    <input name="AdminRule[status]"  <?php if ($model->status) echo  'checked';?> value="1"
                                                           class="ace ace-switch ace-switch-7 " type="checkbox">
                                                    <span class="lbl"></span>
                                                </label>
                                            </div>
