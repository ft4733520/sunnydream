                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <?php $form =  ActiveForm::begin(
                                ['id' => 'admin-role-form',
                                    'action'=>Url::toRoute('admin-user/create'),
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main">
                                                    ...
                                                    <?= $form->field($model, 'username')
                                                        ->textInput(['id' => 'form-field-1','class'=>'col-md-offset-1  col-sm-3','placeholder'=>'用户名'])
                                                    ...
                                                    <?= $form->field($model, 'email')
                                                        ->textInput(['id' => 'form-field-1','class'=>'col-md-offset-1  col-sm-3','placeholder'=>'邮箱'])
                                                        ->label('用户邮箱:',['class'=>'col-sm-3 control-label no-padding-right']) ?>
                                                    <?= $form->field($model, 'password')
                                                        ->passwordInput(['id' => 'form-field-1','class'=>'col-md-offset-1  col-sm-3','placeholder'=>'描述'])
